                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        ...
                        <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
                            ...
                            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                                <button onClick={() => window.location.href = '/auth'} className="px-8 py-3 cursor-pointer bg-indigo-600 text-white font-medium rounded-full shadow-lg hover:bg-indigo-700 transition-colors duration-200">
                                    Start Donating
                                </button>
                            </div>
                        </div>
            ...
            <section className="py-16 px-4 bg-gradient-to-r from-indigo-600 to-indigo-800 text-white">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                        <button onClick={() => window.location.href = '/auth'} className="cursor-pointer px-8 py-3 bg-white text-indigo-700 font-medium rounded-full shadow-lg hover:bg-gray-100 transition-colors duration-200">
                            Start Donating
                        </button>
